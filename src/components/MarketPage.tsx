  ...
  return (
    <div className="animate-fade">
      ...
      <div className="flex flex-wrap gap-2 items-center mt-4 mb-6">
        ...
        {collectionBonus > 0 && (
          <div className="ml-auto glass px-4 py-2.5 text-sm">
        ...
        <div className="max-w-lg mx-auto text-center space-y-6">
          <div className="glass p-8">
            ...
            {gachaResult && !gachaAnimating && (
              <div className={`p-6 border ${rarityColors[gachaResult.rarity]} bg-dark-700/50 mb-6`}>
            ...
            <div className="glass p-6 text-left">
              ...
              <div className="space-y-2">
                {collection.map((name, i) => {
                  ...
                  return card ? (
                    <div key={i} className="flex items-center gap-2 p-2 bg-dark-700/50 text-sm">
                      <span>{card.icon}</span>
